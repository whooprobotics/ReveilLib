...
//   std::vector<PointVector> path_points {{0_in, 0_in}, {0_ft, 6_in}, {1_ft, 6_in}, {1_ft, 0_in}, {2_ft, 0_in}};
//   cout << "Made path points" << endl;
...
TEST(Bezier, BezierVerification3){
  ...
  std::vector<PointVector> path_points {{3_in, 3_in}, {0_in, 6_in}, {24_in, 12_in}, {48_in, 16_in}, {50_ft, 25_in}};
  cout << "Made path points" << endl;
