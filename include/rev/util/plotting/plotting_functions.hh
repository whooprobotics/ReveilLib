...
std::tuple<std::vector<double>, std::vector<double>> decompose_points(
    const std::vector<PointVector> points) {
...
int generate_plot(const std::vector<PointVector> ideal_path,
                  const std::vector<PointVector> actual_path) {
