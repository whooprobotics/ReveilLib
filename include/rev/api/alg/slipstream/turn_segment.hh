...
using OdometryState = rev::OdometryState;
 ...
 *
 */
class SlipstreamTurnSegment : public SlipstreamSegment {
 public:
  SlipstreamTurnSegment(double imax_power,
                        double icoast_power,
                        QAngle iangle,
                        double iharsh_coeff,
                      double icoast_coeff,
  ...
  std::shared_ptr<SlipstreamSegment> operator&() {
    return std::make_shared<SlipstreamTurnSegment>(*this);
  }

  static std::shared_ptr<SlipstreamTurnSegment> create(double imax_power,
                                                       double icoast_power,
                                                     QAngle iangle,
                                                     double iharsh_coeff,
                                                     double icoast_coeff,
                                                     QTime ibrake_time) {
    return std::make_shared<SlipstreamTurnSegment>(imax_power, icoast_power,
                                                   iangle, iharsh_coeff,
...
using TurnSegment = SlipstreamTurnSegment;
