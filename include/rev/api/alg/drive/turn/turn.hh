...
namespace rev { // The namespace is just to separate all of the reveillib code from
//everything else, so we can make sure names dont conflict
// As a general rule, everything thats part of reveillib will be in this namespace
class Turn {
public:
