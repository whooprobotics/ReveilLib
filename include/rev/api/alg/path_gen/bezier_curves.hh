...
class BezierSegment : public PurePursuitSegment {
 public:
   ...
   * @param resolution The resolution of the bezier curve, if left at 0 becomes
   * length of path points times 3. It is important not to set the resolution
   * too high as it can become too computationally intensive
