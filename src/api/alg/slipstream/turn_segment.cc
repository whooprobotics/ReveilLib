#include "rev/api/alg/slipstream/turn_segment.hh"
#include "api.h"
#include "rev/api/units/q_time.hh"

namespace rev {

SlipTurnSegment::SlipTurnSegment(double imax_power,
                                         double icoast_power,
                                         QAngle iangle,
                                         double iharsh_coeff,
                                         double icoast_coeff,
...
void SlipTurnSegment::init(OdometryState initial_state) {
...
SegmentStatus SlipTurnSegment::step(OdometryState current_state) {
